...
public class NuevoGastoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final CategoriasManejador _categoriasManejador=CategoriasManejador.getInstance(this);
			...
			public void onClick(View v) {
				...
				if(v.getId()==R.id.btn_admCateg){
					...
					try{
						...
						Toast.makeText(getApplicationContext(),"Nuevo gasto creado",Toast.LENGTH_SHORT).show();
						txt_descripcion.setText("");
						txt_monto.setText("");
					}catch(Exception e){
						Toast.makeText(getApplicationContext(),"No se pudo crear el nuevo gasto",Toast.LENGTH_SHORT).show();
					}
				}
			}
		};
